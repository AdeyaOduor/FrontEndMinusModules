...
import TargetTrees from './Component/schoolDashboard/userPages/TargetTrees';
...
const routes = [
  {
    path: 'app',
    element: (
      <ProtectedRoute allowedRoles={['ROLE_SCHOOL']} userRole="ROLE_SCHOOL" element={<DashboardLayout />} />
    ),
    children: [
      { path: '', element: <UserDashboard /> },
      { path: 'treeplanting', element: <DataList /> },
      { path: 'targettrees', element: <TargetTrees /> },
...

  {
    path: 'SCDE',
    element: (
      <ProtectedRoute allowedRoles={['ROLE_SUBCOUNTY']} userRole="ROLE_SUBCOUNTY" element={<SCDEDashboardLayout />} />
    ),
    children: [

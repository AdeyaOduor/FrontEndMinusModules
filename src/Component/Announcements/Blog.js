...
const Blog = () => {
  ...
  return (
    ...
    {/* <Container style={containerStyle}> */}
      <Container sx={{ maxWidth: "100%" }} maxWidth={false}  style={containerStyle}>
        ...
        <Grid item xs={12} sm={6} md={6}>
          <div style={{ padding: '5px', textAlign: 'left' }}>
            <Typography variant="h4" gutterBottom>
              <strong>About Elimu Trees</strong>
            </Typography>
            <Typography>
          ...
          <div style={{ padding: '0px' }}>
            <div style={EventsStyles}>
              <div style={EventsStyles2}>
                ...
                <Typography>
                  At Elimu Trees, we organize tree planting events in communities across the globe. We believe that planting trees is a crucial step towards combating climate change and preserving our planet's beauty.
                </Typography>
              </div>
            </div>
          </div>

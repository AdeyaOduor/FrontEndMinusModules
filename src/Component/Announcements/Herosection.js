...
import { Container, Grid, Paper, useMediaQuery, Typography } from "@material-ui/core";
          ...
          {isMobile ? (
            ...
            <Grid container spacing={2}>
              <Paper style={loginCardStyles}>
                ...
                <p>A magnificent tree emerges from the Earth, a symbol of nature's timeless grace.</p>
              </Paper>
              <Paper style={loginCardStyles}>
                <Paper>
                ...
                <p style={{ color: "black" }}>
                  Amidst the serene landscape, a woman actively engages in a tree-planting session, her hands gently cradling a young sapling. With a smile that mirrors the promise of new life, she imparts her love and care into the earth. A brighter future where the seeds of positive change take root and flourish.
                </p>
              </Paper>
              <Paper style={loginCardStyles}>
                <Paper>
                ...
                <p>Inspiring leadership in action as the Principal Secretary joins a tree-planting session. With determination and a shovel in hand, the PS embodies a commitment to environmental stewardship. Together, we strive to create a future where the roots of sustainability grow deep, and the branches of progress reach high.</p>
              </Paper>
              <Paper style={loginCardStyles}>
                <Paper>
                  <img src={image4} alt="Reload!" style={imageStyles} />
                </Paper>
                <p>Youthful pupils, armed with watering cans, eagerly nurture the trees they've planted. With each drop of water, they not only quench the tree's thirst but also sow the seeds of responsibility and environmental consciousness. In their small hands lies the promise of a greener future.</p>
              </Paper>
            </Grid>
          )}
        </Grid>
